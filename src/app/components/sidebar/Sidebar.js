                        ...
                        <ul className="mt-2 -space-y-2" 
                            ...
                            <li className="uk-parent">
                                <a href="#" className="group"> 
                                    ...
                                    <ion-icon name="chevron-down" className="text-base ml-auto duration-200 group-aria-expanded:rotate-180"></ion-icon>              
                                </a>
                                <ul className="pl-10 my-1 space-y-0 text-sm">
                                    <li><a href="components.html" className="!py-2 !rounded -md">Elements</a></li>
                                    <li><a href="components.html" className="!py-2 !rounded -md">Components</a></li>
                                    <li><a href="components.html" className="!py-2 !rounded -md">Icons</a></li>
                                </ul>
                            </li>
