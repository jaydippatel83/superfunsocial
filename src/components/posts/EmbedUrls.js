...
const EmbedUrls = ({ data, lable }) => {
  ...
  const isSocialMediaLink = (url) => {
    const socialMediaRegex =
      /(?:www\.)?(facebook\.com|instagram\.com|linkedin\.com|pinterest\.com|tiktok\.com|twitter\.com|x\.com|youtube\.com)/;
        ...
        imageUrl && (
          <div className="relative ">
            ...
            <Link
              href={url}
              target="_blank"
              className="relative flex cursor-pointer rounded-lg text-sm text-inherit bg-app w-full flex-row"
            >
              {imageUrl && (
                <img
                  loading="lazy"
              ...
              <div className="flex max-h-24 w-full flex-col justify-center overflow-hidden border border-l-0 rounded-r-lg p-2 border-faint  ">
                ...
                <div className="line-clamp-2 max-h-12 max-w-lg text-xs break-gracefully text-faint">
                  {description}
                </div>
