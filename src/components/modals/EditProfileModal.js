...
const EditProfileModal = ({ isModalOpen, toggleModal, userData }) => {
    ...
    return (
        <>
            <button onClick={toggleModal} className="px-4 py-2 bg-gray-100 text-gray-700 rounded-full">
                Edit Profile
            </button>
            {
                isModalOpen && <div className="fixed inset-0 flex items-center justify-center bg-gray-500 bg-opacity-10 backdrop-blur-sm z-[99]">
                        ...
                        <form onSubmit={handleSubmit} className=" mx-auto p-5">
                            <div className="items-center mb-4 relative mx-auto w-fit">
                                ...
                                <input
                                    ...
                                    style={{ display: "none" }}
                                />
                                <button onClick={handleButtonClick} type="button" className="text-blue-500 absolute bottom-[-15px] right-0">
                            ...
                            <button type="submit" className="w-full py-2 bg-blue-700 text-white rounded-md focus:outline-none focus:ring-2 focus:ring-purple-400">
                                Update Profile
                            </button>
                        </form>
                    </div>
