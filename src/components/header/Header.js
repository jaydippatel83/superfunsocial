...
const Header = ({ isSidebarOpen, toggleSidebar }) => {
  return (
    <header className="z-[100] h-[--m-top] fixed top-0 left-0 w-full flex items-center sky-50 backdrop-blur-xl border-b border-slate-200 dark:bg-dark2 dark:border-slate-800 bg-indigo-400">
        ...
        <div className="2xl:w-[--w-side] lg:w-[--w-side-sm]">
          <div className="flex items-center gap-1">
            ...
            >
              ...
              <IonIcon
                icon={closeOutline}
                className={`text-2xl ${isSidebarOpen ? "block" : "hidden"}`}
              />
            </button>
            <div id="logo">
              <Link href="/">
        ...
        <div className="flex-1 ">
          <div className="max-w-[1220px] mx-auto flex items-center">
            ...
            <div className="flex items-center sm:gap-4 gap-2 absolute right-5 top-1/2 -translate-y-1/2 text-black">
              <button
                type="button"
                className="sm:hidden sm:p-2 p-1 rounded-full  sm:bg-secondery dark:text-white"
              >
