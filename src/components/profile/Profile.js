...
import { getFeedByHash, getReactions, getReactionsProfile } from "@/lib/farcaster";

const tabs = ["Feed", "Replies", "Likes"];

const Profile = ({ user, feedData, feedCursor, likeData, likeCursor, recastData, recastCursor }) => {
