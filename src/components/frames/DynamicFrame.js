  ...
  const handleButtonClick = async (buttonAction, buttonTarget, index) => {
    ...
    if (buttonAction === "post_redirect" && buttonTarget) {
      ...
      try {
        ...
        if (pollId === "voted") {
          const previewUrl = `http://demo.superfun.social/api/voted/${choice}`;
        ...
        if (error.reason == "You have already voted!") {
          ...
          if (currentPollId !== "voted") {
            getVotesUrl = `http://demo.superfun.social/api/voted/${currentPollId}`;
          } else if (currentPollId == "voted") {
            getVotesUrl = `http://demo.superfun.social/api/voted/${currentChoice}`;
          }
